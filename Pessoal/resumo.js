        ...
        resumos: [
                ...
                conteudo: [
                    {
                        ...
                        texto: 'Ao final do módulo, o estudante deve ser capaz de: compreender os conceitos do design centrado no usuário; diferenciar IHC, Usabilidade e UX Design; identificar disciplinas que apoiam o design de sistemas; conhecer práticas do bom design; entender e aplicar os critérios ergonômicos de Scapin e Bastien.'
                    },
                    {
                        subtitulo: '🔎 O que é Design?',
                        texto: 'Design não é apenas estética. Significa projetar, compor visualmente e colocar em prática um plano intencional. Não basta ser bonito — precisa ser funcional e cumprir um objetivo. O designer combina palavras, imagens, vídeos e sons para criar experiências coerentes.'
                    },
                    {
                        subtitulo: '🖥 Design de Sistemas',
                        texto: 'O design de sistemas cria produtos que favorecem a interação entre pessoas e computadores. Problema comum: desenvolvedores focam apenas na tecnologia e esquecem como as pessoas interagem com o sistema. É aqui que entra o foco no usuário.'
                    },
                    {
                        subtitulo: '🧠 IHC — Interação Humano-Computador',
                        texto: 'Surgiu na década de 1970. Origem: Ergonomia, Psicologia Cognitiva, Design e Computação. Estuda a relação entre o sistema e o usuário. ⚠ Interface (IU) é a parte visível. ⚠ IHC é o estudo da interação como um todo.'
                    },
                    {
                        subtitulo: '⚙ Usabilidade',
                        texto: 'Segundo a NBR 9241-11: é a medida pela qual um produto pode ser usado com eficácia, eficiência e satisfação. Ela considera: cognição, memória (curto e longo prazo), percepção, atenção e tomada de decisão. Hoje, usabilidade é o mínimo esperado.'
                    },
                    {
                        subtitulo: '🌟 UX — Experiência do Usuário',
                        texto: 'Vai além da eficiência. Inclui: prazer, emoção, afetividade, encantamento e desejabilidade. UX analisa se o usuário se encanta a ponto de querer continuar usando o sistema. O foco principal do designer deve ser sempre o usuário.'
                    },
                    {
                        subtitulo: '🎮 Design de Interação',
                        texto: 'Estuda como ocorre a interação entre usuário e sistema. Envolve: elementos físicos e digitais, compatibilidade com expectativas do usuário, consistência, padronização, controle do usuário e interrupção de ações. É uma visão ampla que envolve teoria, pesquisa e prática.'
                    },
                    {
                        subtitulo: '🖼 Design de Interface',
                        texto: 'Foco: ambiente visual onde ocorre a interação. Elementos: ícones, botões, textos, feedback, condução e códigos. A interface deve ser fluida, consistente, intuitiva e adequada ao público-alvo. Princípios do Bom Design (Sobral): (a) Visibilidade — o usuário deve reconhecer facilmente as funções; (b) Consistência — elementos devem manter padrão visual; (c) Familiaridade — usar ícones e padrões conhecidos; (d) Affordance — a interface deve "ensinar" a usar sem manual.'
                    },
                    {
                        subtitulo: '🗂 Arquitetura da Informação',
                        texto: 'Organiza o conteúdo do sistema. Envolve: estruturação, hiperligações, legibilidade, disponibilidade, fluidez, categorização e menus e submenus bem rotulados. Uma boa arquitetura melhora a experiência geral.'
                    },
                    {
                        subtitulo: '📏 Critérios Ergonômicos de Scapin e Bastien',
                        texto: 'A ergonomia organiza os elementos da interface de forma metódica e alinhada à usabilidade. Base teórica: Bastien e Scapin (1993). São 8 critérios complementares: (1) Compatibilidade — a interface está adequada às características do usuário? Considera memória, idade, habilidades e expectativas. (2) Condução — a interface orienta o usuário? Inclui feedback imediato, agrupamento de itens, legibilidade e ajuda ao aprendizado. (3) Carga de Trabalho — evita excesso de informação? Subcritérios: brevidade, concisão, ações mínimas e baixa densidade informacional. Objetivo: reduzir esforço cognitivo. (4) Homogeneidade — manter padrões em contextos semelhantes: consistência de códigos, nomes, formatos e procedimentos. (5) Significado dos Códigos — os símbolos representam corretamente sua função? Ex: ícone de lixeira para excluir. (6) Controle Explícito — o usuário tem controle sobre o sistema? Pode interromper, suspender e confirmar ações. (7) Adaptabilidade — sistema se adapta ao nível do usuário? Ajuda para iniciantes, diálogo para intermediários, atalhos para avançados. Inclui personalização. (8) Gestão de Erros — o sistema prevê erros, informa claramente e permite correção. Ex: mensagem de confirmação antes de excluir.'
                    },
                    {
                        subtitulo: '🏁 Conclusão da Aula',
                        texto: 'Um design centrado no usuário: vai além da implementação técnica, busca usabilidade eficiente, proporciona experiência imersiva, é intuitivo, considera diferentes níveis de usuários e avalia constantemente erros e melhorias. O designer precisa ser multidisciplinar e dominar: IHC, Usabilidade, UX, Design de Interface, Arquitetura da Informação e Ergonomia.'
                    },
                    {
                        subtitulo: '🎯 Pontos Mais Importantes da Aula',
                        texto: '1. UX é mais amplo que usabilidade. 2. Design não é apenas estética — é funcionalidade. 3. Interface é parte do sistema, IHC é o estudo da relação. 4. Ergonomia organiza a interface metodicamente. 5. Os 8 critérios de Bastien e Scapin são base para avaliação.'
                    },
                    {
                        subtitulo: '📝 Resumo Ultra Simplificado',
                        texto: 'Design centrado no usuário busca criar sistemas funcionais, intuitivos e desejáveis. IHC estuda a interação entre usuário e sistema. Usabilidade mede eficiência e satisfação. UX amplia para emoção e encantamento. Os 8 critérios ergonômicos garantem qualidade na interface.'
                    }
                ],
                lida: false
            },
            {
                ...
                conteudo: [
                    {
                        subtitulo: '🎯 Objetivos da Aula',
                        texto: 'Ao final do módulo, o estudante deve ser capaz de: reconhecer a importância dos elementos comunicativos; compreender os conceitos de fenomenologia e semiótica; entender como os signos influenciam a percepção; analisar e aplicar signos em interfaces gráficas; utilizar métodos de avaliação da comunicabilidade.'
                    },
                    {
                        subtitulo: '🗣 O que é Comunicabilidade?',
                        texto: 'Comunicabilidade é a capacidade de um sistema comunicar ao usuário: como ele funciona, o que pode ser feito e como deve ser usado. Não é apenas transmitir informação, mas garantir que o usuário compreenda a intenção do sistema. Base teórica: Modelo de Comunicação de Jakobson (1960). Comunicação envolve: emissor, mensagem, receptor, código, canal e contexto. Em sistemas interativos: o designer é o emissor, a interface é a mensagem e o usuário é o receptor.'
                    },
                    {
                        subtitulo: '🌐 Evolução da Web e Comunicação',
                        texto: 'Web 1.0: ambiente estático, sites corporativos, fonte unilateral de informação, usuário passivo. Web 2.0: interação e compartilhamento, páginas dinâmicas, redes sociais, usuário criando conteúdo. Web 3.0: web semântica, processos interpretativos, sistematização das informações, dados organizados de forma inteligente. Web 4.0: mobilidade, ubiquidade, inteligência artificial, sistemas altamente adaptativos.'
                    },
                    {
                        subtitulo: '📖 Semiótica',
                        texto: 'Ciência que estuda os signos. Principal referência: Charles Sanders Peirce (1839–1914). A semiótica estuda: como os signos representam algo, como são interpretados e como produzem significado.'
                    },
                    {
                        subtitulo: '🎨 Fenomenologia',
                        texto: 'Estudo da experiência humana. Relaciona-se com: estética, ética e lógica. A fenomenologia ajuda a entender como o usuário percebe e interpreta a interface.'
                    },
                    {
                        subtitulo: '💡 Engenharia Semiótica',
                        texto: 'A Engenharia Semiótica é uma disciplina da IHC centrada na comunicação. Ideia central: sistemas são metacomunicadores — o sistema comunica ao usuário as decisões e intenções do designer. O usuário aprende com o sistema por meio de: signos visuais, estruturas de navegação, feedback e padrões de interação. A semiótica envolve: cultura, conhecimento prévio e contexto social. Se a comunicação falha, ocorre problema de comunicabilidade.'
                    },
                    {
                        subtitulo: '🧪 Método MAC',
                        texto: 'MAC = Método de Avaliação de Comunicabilidade. Etapas: 1. Preparação do teste; 2. Coleta de dados; 3. Análise dos dados. O objetivo é identificar: ruídos na comunicação, dificuldades de interpretação e quebras de entendimento.'
                    },
                    {
                        subtitulo: '🔎 Inspeção Semiótica',
                        texto: 'Método analítico baseado na análise dos signos presentes na interface. Etapas: inspeção dos signos metalinguísticos (textos explicativos, tutoriais, ajuda); inspeção dos signos estáticos (ícones, layout, cores, elementos fixos); inspeção dos signos dinâmicos (animações, feedback, mudanças de estado); contraste e comparação entre análises; apreciação da qualidade da metacomunicação.'
                    },
                    {
                        subtitulo: '🎯 Pontos Mais Importantes da Aula',
                        texto: '1. Comunicabilidade é a capacidade do sistema transmitir sua intenção ao usuário. 2. Semiótica estuda como os signos produzem significado. 3. Engenharia Semiótica vê o sistema como um metacomunicador. 4. MAC e Inspeção Semiótica avaliam a qualidade da comunicação. 5. A evolução da web mudou a forma como nos comunicamos digitalmente.'
                    },
                    {
                        subtitulo: '📝 Resumo Ultra Simplificado',
                        texto: 'Comunicabilidade é a capacidade de um sistema se fazer entender pelo usuário. A semiótica estuda os signos e seus significados. Engenharia Semiótica analisa como sistemas comunicam decisões do designer. MAC e Inspeção Semiótica avaliam falhas na comunicação. Uma boa interface comunica claramente suas intenções.'
                    }
                ],
                lida: false
            },
            {
                ...
                conteudo: [
                    {
                        subtitulo: '🎯 Objetivos da Aula',
                        texto: 'Ao final do módulo, o estudante deve ser capaz de: compreender o conceito de alfabetismo visual; entender os fundamentos sintáticos da linguagem visual; identificar os elementos básicos da comunicação visual; aplicar esses elementos na construção de interfaces gráficas.'
                    },
                    {
                        subtitulo: '👁 O que é Linguagem Visual?',
                        texto: '"Uma imagem vale mais que mil palavras." Em uma era de excesso de informações, a comunicação visual torna-se essencial para: chamar atenção, transmitir significado, criar identidade visual e melhorar a experiência do usuário. A linguagem visual é a forma de comunicação baseada em: imagens, cores, formas, direções, texturas e movimento. Assim como existe um alfabeto verbal, existe também um alfabeto visual.'
                    },
                    {
                        subtitulo: '🔤 O que é Alfabetismo Visual?',
                        texto: 'Assim como alguém alfabetizado verbalmente conhece letras, gramática e sintaxe, o alfabetizado visual: conhece os elementos visuais, entende seus significados, sabe combiná-los e consegue analisar e sintetizar composições. ⚠ Diferente do alfabeto verbal, o visual é: menos rígido, mais interpretativo e culturalmente influenciado. O designer resolve problemas por meio de: análise (investigação do problema) e síntese (criação da solução visual). O computador ampliou as possibilidades criativas, mas os fundamentos visuais continuam os mesmos.'
                    },
                    {
                        subtitulo: '🖼 Classificação das Mensagens Visuais',
                        texto: 'As mensagens visuais podem ser classificadas em três níveis: (1) Representacional — representa o mundo real da forma mais fiel possível; fácil reconhecimento, próximo da realidade, pouca abstração. Ex: fotografia de um objeto real. (2) Abstrato — simplificação da realidade; redução de detalhes, ênfase em formas e cores, expressão mais subjetiva; usado para intensificar significado. (3) Simbólico — redução radical da representação; elementos mínimos, fácil memorização, ícones e sinais. Ex: ícones de interface. Esses três níveis podem se interligar, se sobrepor e variar conforme o contexto.'
                    },
                    {
                        subtitulo: '⚫ Os 10 Elementos Básicos da Leitura Visual',
                        texto: '(1) Ponto — unidade visual mínima, referência no espaço, direciona o olhar, em conjunto cria tom e textura, base do pontilhismo. (2) Linha — energética, nunca totalmente estática, direcional, pode ser técnica ou expressiva; linha diagonal = tensão e instabilidade. (3) Forma — três formas básicas: quadrado (estabilidade, honestidade), triângulo (tensão, ação), círculo (proteção, continuidade); todas as formas derivam dessas bases. (4) Direção — cada forma sugere uma direção: horizontal/vertical = equilíbrio, diagonal = instabilidade, curva = suavidade e repetição. (5) Tom — variação entre luz e sombra, cria profundidade e permite distinguir formas. (6) Cor — forte impacto emocional, elemento de grande apelo comunicacional; deve considerar aspectos físicos, fisiológicos e culturais. (7) Textura — pode ser percebida visualmente, enriquece superfícies e cria contraste. (8) Escala — relação de tamanho, define peso visual e cria hierarquia. (9) Dimensão — ilusão de profundidade, uso de perspectiva, representação 3D em plano 2D. (10) Movimento — ilusão de dinamismo, uso de repetição, desfoque, sequência e animação; é uma das forças visuais mais dominantes da experiência humana.'
                    },
                    {
                        subtitulo: '🏁 Conclusão da Aula',
                        texto: 'Existe um alfabeto visual assim como o verbal. Ele é menos rígido, mas igualmente estruturado. Os 10 elementos básicos formam a base da linguagem visual. Cada elemento transmite uma metamensagem. Estética deve sempre estar alinhada à usabilidade. Interfaces criativas utilizam os elementos básicos de forma coerente, intencional e esteticamente alinhada à usabilidade.'
                    },
                    {
                        subtitulo: '🎯 Pontos Mais Importantes da Aula',
                        texto: '1. Alfabetismo visual é domínio consciente dos elementos visuais. 2. Existem três níveis de mensagem: representacional, abstrato e simbólico. 3. Os 10 elementos básicos estruturam qualquer composição visual. 4. Cada elemento transmite significado cognitivo. 5. A escolha correta dos elementos fortalece a identidade visual.'
                    },
                    {
                        subtitulo: '📝 Resumo Ultra Simplificado',
                        texto: 'O alfabetismo visual é o domínio da linguagem das imagens. Mensagens visuais podem ser representacionais, abstratas ou simbólicas. Existem 10 elementos básicos que estruturam qualquer composição. Cada elemento transmite uma metamensagem específica. Interfaces eficazes combinam estética e usabilidade.'
                    }
                ],
                lida: false
            },
            {
                ...
                conteudo: [
                    {
                        subtitulo: '🎯 Objetivos da Aula',
                        texto: 'Ao final da aula, o estudante deve ser capaz de: compreender os estudos da Psicologia Cognitiva aplicados à IHC; identificar os pilares da Gestalt da Forma; analisar a aplicação prática da Gestalt em interfaces gráficas.'
                    },
                    {
                        subtitulo: '🧠 Psicologia Cognitiva',
                        texto: 'A construção de interfaces eficientes depende da compreensão de como o ser humano percebe, interpreta, memoriza e toma decisões. A Psicologia Cognitiva estuda os processos mentais envolvidos no pensamento humano: imagens mentais, atenção, consciência, percepção, memória, linguagem, resolução de problemas, criatividade, tomada de decisão, raciocínio, desenvolvimento cognitivo ao longo da vida, inteligência humana e inteligência artificial. Na IHC, o foco principal está em atenção e memória.'
                    },
                    {
                        subtitulo: '🔎 Tipos de Atenção',
                        texto: '(1) Atenção Seletiva — foco em um estímulo específico ignorando outros. (2) Vigilância e Detecção de Sinal — manter atenção por longos períodos para identificar eventos importantes. (3) Sondagem — busca ativa por informações no ambiente. (4) Atenção Dividida — capacidade de realizar mais de uma tarefa ao mesmo tempo. Em interfaces: excesso de informação reduz foco.'
                    },
                    {
                        subtitulo: '🧠 Memória e Processo de Ação',
                        texto: 'Memória de Curta Duração: temporária e limitada. Memória de Longa Duração: armazenamento permanente. Interfaces devem reduzir carga cognitiva e evitar exigir memorização excessiva. A interação do usuário segue três grandes etapas: (1) Análise da Situação — ativação, observação, categorização e interpretação; (2) Planificação das Ações — avaliação das possibilidades, definição da tarefa e definição dos procedimentos; (3) Controle das Ações — baseado em habilidades, regras e conhecimentos. Interfaces devem facilitar esse fluxo.'
                    },
                    {
                        subtitulo: '👁 Gestalt da Forma',
                        texto: 'A Gestalt estuda como percebemos padrões e organizamos estímulos visuais. Premissa básica: o todo é maior que a soma das partes. Princípios fundamentais: (1) Tendência à estruturação — o cérebro organiza estímulos automaticamente; (2) Segregação Figura-Fundo — separação entre elemento principal e plano de fundo; (3) Constância Perceptiva — reconhecimento de objetos mesmo com mudanças; (4) Pregnância — preferência por formas simples, estáveis e organizadas.'
                    },
                    {
                        subtitulo: '🧩 Os 8 Pilares da Gestalt em Interfaces',
                        texto: '(1) Unidades — elementos percebidos como partes organizadas. (2) Unificação — agrupamento que gera sensação de conjunto. (3) Continuidade — o olhar segue linhas e direções naturalmente. (4) Proximidade — elementos próximos são percebidos como relacionados. (5) Semelhança — elementos semelhantes são agrupados mentalmente. (6) Segregação — diferenciação clara entre figura e fundo. (7) Fechamento — tendência a completar formas incompletas. (8) Pregnância da Forma — preferência por formas simples e organizadas.'
                    },
                    {
                        subtitulo: '🎯 Pontos Mais Importantes da Aula',
                        texto: '1. Interfaces devem considerar atenção e memória. 2. O usuário passa por análise, planejamento e controle ao interagir. 3. O cérebro organiza estímulos automaticamente. 4. Gestalt fornece princípios práticos para design. 5. Simplicidade e organização aumentam eficiência visual.'
                    },
                    {
                        subtitulo: '📝 Resumo Ultra Simplificado',
                        texto: 'Psicologia Cognitiva estuda como pensamos, percebemos e memorizamos. A atenção e a memória são essenciais na interação humano-computador. A Gestalt explica como organizamos estímulos visuais. Existem 8 pilares aplicáveis ao design de interfaces. Interfaces boas reduzem esforço cognitivo e organizam bem a informação.'
                    }
                ],
                lida: false
            },
            {
                ...
                conteudo: [
                    {
                        subtitulo: '🎯 Tema',
                        texto: 'A Aula 5 aborda como aplicar cores de forma estratégica em projetos visuais, considerando aspectos técnicos, psicológicos e culturais para criar interfaces eficientes, atrativas e comunicativas.'
                    },
                    {
                        subtitulo: '🔴 Critérios para Escolha de Cores',
                        texto: 'A escolha de cores não é aleatória. Ela depende de: fatores fisiológicos (como o olho humano percebe as cores), psicológicos (impacto emocional das cores), culturais (significados variam entre culturas), contextuais (objetivo do projeto) e público-alvo (idade, preferências, hábitos). A cor deve ser escolhida com base na mensagem que se quer transmitir.'
                    },
                    {
                        subtitulo: '🧠 Psicologia das Cores',
                        texto: 'As cores possuem efeitos diferentes no corpo humano. Cores Quentes (vermelho, amarelo): comprimento de onda maior, exigem mais energia do cérebro, efeito: estímulo, agitação, atenção. Cores Frias (azul, verde, violeta): comprimento de onda menor, exigem menos energia, efeito: calma, relaxamento. O significado das cores não é universal: vermelho pode significar energia, fome ou raiva; preto = morte (cultura ocidental); branco = morte (cultura hindu). A interpretação depende de cultura, religião e experiência pessoal.'
                    },
                    {
                        subtitulo: '🌈 Significado das Cores',
                        texto: 'Azul: paz, confiança, serenidade, harmonia. Amarelo: alerta, energia, euforia, esperança. Vermelho: paixão, perigo, energia, ação. Verde: saúde, natureza, equilíbrio, esperança. Laranja: alegria, entusiasmo, criatividade. Violeta: calma, dignidade, espiritualidade. Esses significados ajudam a definir a identidade visual de um projeto.'
                    },
                    {
                        subtitulo: '🧩 Processo de Criação de Esquema de Cores',
                        texto: '1º Passo — Escolher a cor principal: base do design, pode vir da marca ou do objetivo do projeto, considerar psicologia e cultura. 2º Passo — Regra 60-30-10: 60% = cor dominante (fundo/base), 30% = cor secundária (textos/elementos), 10% = cor de destaque (detalhes). Garante equilíbrio visual e organização. 3º Passo — Escolher o esquema de cores baseado no círculo cromático: cores análogas (harmonia), complementares (contraste), tríade (equilíbrio vibrante) e monocromático (variações de uma cor).'
                    },
                    {
                        subtitulo: '💻 RGB vs CMYK na Prática',
                        texto: 'RGB (luz) → telas digitais; mais variedade de cores. CMYK (pigmento) → impressão; menor gama de cores. Regra essencial: digital = RGB, impressão = CMYK. Ferramenta de apoio: Adobe Color — gera combinações e permite criar paletas monocromáticas, complementares e tríades. Facilita a tomada de decisão visual.'
                    },
                    {
                        subtitulo: '⚖️ Boas Práticas no Uso da Cor',
                        texto: 'Essenciais: não escolher cores aleatoriamente, pensar no público-alvo, considerar emoção e cultura, manter equilíbrio visual. Importantes: usar contraste para destacar elementos, usar harmonia para conforto visual, definir hierarquia visual com cores. Complementares: testar combinações antes de aplicar, usar ferramentas de apoio, ajustar conforme contexto do projeto.'
                    },
                    {
                        subtitulo: '🧭 Conclusão e Resumo Final',
                        texto: 'A cor é uma ferramenta poderosa de comunicação visual. Quando bem utilizada, ela: guia o usuário, transmite emoções, reforça a identidade e melhora a experiência. Porém exige planejamento, análise do contexto e conhecimento técnico. Síntese: cor = comunicação + emoção. Escolha baseada em psicologia + cultura + objetivo. Use a regra 60-30-10 para equilíbrio. Combine cores com técnica (círculo cromático). RGB para digital, CMYK para impressão.'
                    }
                ],
                lida: false
            },
            {
                ...
                conteudo: [
                    {
                        subtitulo: '🎯 Tema',
                        texto: 'A Aula 6 aborda como aplicar a tipografia de forma estratégica em projetos digitais, considerando fatores como legibilidade, alinhamento, tamanho, peso e adaptação a diferentes dispositivos, com o objetivo de criar interfaces claras, funcionais e visualmente equilibradas.'
                    },
                    {
                        subtitulo: '🔴 Importância do Uso da Tipografia',
                        texto: 'A tipografia não é apenas estética — ela impacta diretamente a experiência do usuário (UX). A escolha da fonte influencia: legibilidade, conforto visual e compreensão da informação. Tipografia bem aplicada: facilita a navegação, reduz esforço de leitura e melhora a experiência geral. Há diferença entre uso em meios impressos e meios digitais (sites, apps). Antes havia limitação de fontes na web; hoje é possível usar diversas fontes com CSS @font-face e serviços como Google Fonts.'
                    },
                    {
                        subtitulo: '🔴 Tipos de Fonte: Serifadas vs Sem Serifas',
                        texto: 'Serifadas (Serif): possuem pequenos traços nas extremidades, indicadas para textos longos, vantagem: melhor fluxo de leitura e menor cansaço visual, transmitem tradição e formalidade. Sem serifas (Sans Serif): não possuem esses traços, indicadas para telas (celulares, computadores), vantagem: melhor leitura em resolução digital, transmitem modernidade e simplicidade.'
                    },
                    {
                        subtitulo: '🔴 Alinhamento Tipográfico',
                        texto: 'Função do alinhamento: criar organização, unidade visual e hierarquia. Alinhamento à esquerda (recomendado): mais natural para leitura, segue padrão ocidental (esquerda → direita). Justificado: pode causar espaços irregulares ("caminhos de rato"), problema comum na web por falta de hifenização. Centralizado: uso recomendado para títulos e frases curtas; evitar em textos longos.'
                    },
                    {
                        subtitulo: '🔴 Tamanho da Fonte e Responsividade',
                        texto: 'Padrão navegadores: 16px (desktop). Mobile: pode começar em 12px. Ajustar espaçamento entre linhas conforme dispositivo. Tamanho por faixa etária: menor de 7 anos = 24, 7–8 anos = 18, 8–9 anos = 14, 10–11 anos = 12, adultos = 10. O tamanho varia conforme a fonte (ex: Garamond vs Minion). Unidade EM (recomendada): flexível e adaptável a qualquer tela. Pixels (px): precisão, mas pouca flexibilidade.'
                    },
                    {
                        subtitulo: '🔴 Quantidade de Caracteres por Linha',
                        texto: 'Legibilidade refere-se ao esforço necessário para ler e entender. Desktop: ideal de 50 a 80 caracteres por linha. Mobile: ideal de 30 a 35 caracteres. Linhas muito longas cansam; linhas muito curtas quebram o ritmo de leitura.'
                    },
                    {
                        subtitulo: '🔴 Peso da Tipografia (Font Weight)',
                        texto: 'Peso é a espessura dos traços da fonte. Principais variações: Light (fino), Regular (normal), Bold (negrito), Black (muito pesado), Condensed (mais estreito), Extended (mais largo), Outline (contorno). Fontes gratuitas têm menos variações; fontes pagas têm mais opções. Dica CSS: font-weight: normal;'
                    },
                    {
                        subtitulo: '🔴 Aplicação Estratégica e Resumo Final',
                        texto: 'A decisão tipográfica deve considerar: objetivo do projeto, público-alvo, dispositivo (desktop/mobile) e tipo de conteúdo. Impacto direto em: UX, clareza da informação e estética do design. A tipografia deve ser escolhida estrategicamente, não apenas visualmente. O mesmo texto pode ter experiências totalmente diferentes dependendo da tipografia. Uma boa tipografia: facilita a leitura, melhora a navegação, enriquece o design e influencia a percepção do usuário.'
                    }
                ],
                lida: false
            },
            {
                ...
                conteudo: [
                    {
                        subtitulo: '🎯 Tema',
                        texto: 'A Aula 7 aborda como utilizar imagens de forma técnica, semiótica e comunicativa, considerando seus significados, formatos e aplicações para criar interfaces visuais eficientes, expressivas e funcionais.'
                    },
                    {
                        subtitulo: '🔴 Conceito de Imagem',
                        texto: 'A imagem é um elemento visual com forte poder simbólico e emocional. Substitui experiências reais na mente do observador. A imagem é um signo visual que pode ser representacional (realista) ou abstrata. Atua junto ao texto, reforçando significado. A imagem não resolve o design sozinha — precisa estar em harmonia com o projeto.'
                    },
                    {
                        subtitulo: '🔴 Função Comunicativa da Imagem',
                        texto: 'Associação por contiguidade: imagem + texto criam significado conjunto. Ex: logotipo com símbolo ativa memória. Impacto psicológico: a imagem evoca memória, cria associações mentais e influencia percepção.'
                    },
                    {
                        subtitulo: '🔴 Imagem na Semiótica — Tipos de Signos',
                        texto: 'Segundo a semiótica: signo = objeto + interpretação + representação. Tipos de signos: (1) Ícone — relação por semelhança, representa visualmente o objeto. Ex: ícone da Torre Eiffel = Paris. (2) Índice (indício) — relação de causa ou evidência, indica algo indiretamente. Ex: fumaça = fogo, pegadas = alguém passou. (3) Símbolo — relação cultural/convenção, depende de interpretação social. Ex: pomba branca = paz, cruz = cristianismo. Observação: nem toda imagem precisa representar algo (imagens abstratas).'
                    },
                    {
                        subtitulo: '🔴 Percepção e Composição Visual',
                        texto: 'Uma imagem pode ter múltiplos significados. Influência da composição: posição central = neutra; deslocada = dinâmica; pequena = isolamento; cortada = impacto/força. Exemplo: pontos formando triângulo — o cérebro interpreta a forma mesmo sem ela existir.'
                    },
                    {
                        subtitulo: '🔴 Classificação das Imagens',
                        texto: 'Bitmap: baseado em pixels, usado em fotografias. Vetor: baseado em fórmulas matemáticas, usado em ilustrações. Fotografia: representação real, mensagem direta, alta credibilidade; uso ideal para informações rápidas e realismo. Ilustração: mais criativa e interpretativa, estimula imaginação; uso ideal para criatividade e comunicação conceitual. Comparação: fotografia tem alto realismo e alta objetividade; ilustração tem alta criatividade e realismo baixo.'
                    },
                    {
                        subtitulo: '🔴 Formatos de Imagem',
                        texto: 'BMP: sem perda de qualidade, mas arquivos grandes. GIF: compacto, sem perda, máx. 256 cores; indicado para gráficos simples. PNG: alta qualidade, suporta transparência, arquivo maior; indicado para imagens com transparência. JPEG: boa compressão, mas perde qualidade; indicado para fotos. TIFF: alta qualidade, muito pesado; indicado para impressão.'
                    },
                    {
                        subtitulo: '🔴 Relação Imagem + Texto',
                        texto: 'Tipos de interação: (1) Redundância — texto mais importante, imagem complementa; (2) Informatividade — imagem mais importante, ex: infográficos; (3) Complexidade — texto + imagem com mesmo peso. Técnicas: Ancoragem — texto direciona interpretação da imagem; Relais — texto + imagem se complementam mutuamente. Relação incoerente entre imagem e texto prejudica a comunicação.'
                    },
                    {
                        subtitulo: '🔴 Imagem no Meio Digital',
                        texto: 'Características: interatividade, dinamismo, possibilidade de clique, zoom e navegação. Limitações técnicas: velocidade da internet, peso da imagem e tempo de carregamento. Boas práticas: escolher formato adequado, otimizar tamanho, manter qualidade suficiente e pensar na experiência do usuário. Papel do designer: criatividade é essencial, ferramentas não substituem conhecimento, imagem deve seguir o conceito do projeto.'
                    },
                    {
                        subtitulo: '🧠 Resumo Final',
                        texto: 'A imagem é um elemento fundamental da comunicação visual, com forte impacto emocional, simbólico e funcional. Elementos-chave: semiótica (ícone, índice, símbolo), tipos de imagem (bitmap e vetor), fotografia vs ilustração, formatos (PNG, JPG, etc.) e interação com texto. A imagem não comunica sozinha — depende de contexto e composição. Uma imagem bem utilizada: comunica mais rápido que texto, influencia percepção, melhora a experiência do usuário e reforça a mensagem do projeto.'
                    }
                ],
                lida: false
            },
            {
                ...
                conteudo: [
                    {
                        subtitulo: '🎯 Tema',
                        texto: 'A Aula 8 aborda como organizar elementos visuais de forma estratégica para criar interfaces eficientes, legíveis e com boa experiência do usuário (UX), utilizando princípios como contraste, harmonia, composição e grids.'
                    },
                    {
                        subtitulo: '🔴 Conceito de Layout',
                        texto: 'Layout é a organização hierárquica dos elementos visuais. Integra: cores, tipografia e imagens. Objetivo: garantir legibilidade, usabilidade e comunicação eficiente. Função: organizar elementos para criar interação intuitiva e facilitar tarefas do usuário. A forma de apresentação é mais importante que os elementos isolados. Layout pode ser estruturado (mais fácil de entender) ou não estruturado (mais criativo, porém mais complexo). Técnicas tradicionais de revistas e livros também se aplicam ao digital: grid, regra dos terços e peso visual.'
                    },
                    {
                        subtitulo: '🔴 Dinâmica do Contraste e Harmonia',
                        texto: 'Harmonia = organização, equilíbrio. Contraste = tensão visual, destaque. Ambos são necessários e devem ser usados com intenção. Estados da composição: (1) Nivelamento (harmonia) — elementos alinhados nos eixos vertical/horizontal, sensação de estabilidade; (2) Aguçamento (contraste) — elementos fora do eixo, sensação de dinamismo e tensão; (3) Ambiguidade — nem harmônico nem contrastante, gera confusão visual (⚠ evitar). Tipos de contraste: Tom (claro vs escuro), Cor (diferença de cores), Forma (regular vs irregular), Escala (grande vs pequeno). Regra: contraste só existe com oposição entre elementos.'
                    },
                    {
                        subtitulo: '🔴 Técnicas Visuais de Design (Polaridades)',
                        texto: 'As técnicas funcionam em pares opostos: (1) Equilíbrio x Instabilidade — equilíbrio = estável e seguro; instabilidade = tensão e movimento visual. (2) Simetria x Assimetria — simetria = efeito espelho; assimetria = diferentes, mas equilibrados (baseada em proximidade, continuidade e similaridade da Gestalt). (3) Regularidade x Irregularidade — regularidade = padrão constante; irregularidade = surpresa visual. (4) Simplicidade x Complexidade — simplicidade = fácil percepção (pregnância); complexidade = muitos elementos, mas pode ser organizada. (5) Unidade x Fragmentação — unidade = percepção do todo; fragmentação = elementos separados, mas relacionados. (6) Economia x Profusão — economia = poucos elementos; profusão = muitos elementos (riqueza visual). (7) Minimização x Exagero — minimização = "menos é mais"; exagero = ampliação de características visuais.'
                    },
                    {
                        subtitulo: '🔴 Layout em Interfaces Gráficas',
                        texto: 'É a etapa crítica do projeto — a interface é o ponto de contato com o usuário. Três pilares do layout: (1) Navegação — regra dos 3 cliques, acesso rápido às informações; (2) Lógica visual — organização intuitiva, uso de princípios visuais; (3) Templates — estrutura padrão reutilizável, mantém consistência visual. Sites imitam estrutura de livros e revistas.'
                    },
                    {
                        subtitulo: '🔴 Grid (Grade de Layout)',
                        texto: 'Grid é uma estrutura com linhas e colunas. Função: organizar elementos e garantir consistência. Vantagens: organização clara, rapidez no desenvolvimento e padronização. O grid não limita a criatividade — serve como guia. Estrutura comum: grid de 12 colunas (permite várias divisões). Para responsividade, usar medidas em porcentagem (%). Fórmula de conversão: objeto ÷ largura total = resultado. Ex: 300px ÷ 960px = 31,25%.'
                    },
                    {
                        subtitulo: '🔴 Comportamento do Usuário e Leitura',
                        texto: 'Padrão ocidental: leitura da esquerda para direita, de cima para baixo. Aplicação prática: elementos principais devem estar no topo ou à esquerda. Uso de contraste, cor e peso visual para guiar o olhar.'
                    },
                    {
                        subtitulo: '🧠 Resumo Final',
                        texto: 'O layout é a organização estratégica dos elementos visuais, responsável por garantir clareza, usabilidade e impacto visual. Elementos-chave: contraste vs harmonia, técnicas visuais (polaridades), grid e estrutura, navegação e UX. Um bom layout não depende só dos elementos, mas de como eles são organizados. Um layout bem planejado: facilita a navegação, melhora a experiência do usuário, destaca informações importantes e torna o design eficiente e profissional.'
                    }
                ],
                lida: false
            }
